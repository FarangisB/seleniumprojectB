...
public class T1_xpath_cssSelector_practice {
    ...
    // Locate homeLink using cssSelector, class value, syntax2
    ...
    //  WebElement header_x2 = driver.findElement(By.xpath("//h2[.='Forgot Password']")); -> we can use    .    instead of header
        WebElement header_x2 = driver.findElement(By.xpath("//h2[text()='Forgot Password']"));
    ...
    //    d. E-mail input box
        ...
        // Label inputBox using xpath contains method
